...
ERROR = {
    125002: 'ERROR_LOGIN_SESSION_EXPIRED',  # Guess?

}

# http://stackoverflow.com/questions/9711504/defining-a-list-of-error-messages-and-error-codes

error_type = dict(
    (v,k) for k,v in ERROR.items()
)
...
class HuaweiDeviceException(DeviceException):
    pass
